...
//go:generate swagger generate server --target ../../server --name Frogbot --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.FrogbotAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.FrogbotAPI) http.Handler {
	...
	if api.GetFrogNameHandler == nil {
		api.GetFrogNameHandler = operations.GetFrogNameHandlerFunc(func(params operations.GetFrogNameParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetFrogName has not yet been implemented")
		})
	}
